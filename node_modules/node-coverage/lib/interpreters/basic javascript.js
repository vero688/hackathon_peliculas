...
// This interpreter applies to any JS file regardless of the content
exports.filter = {
	files : /\.js$/
};
...
exports.interpret = function (file, content, options) {
	...
	} else if (clientCode.shouldBeExcluded(file, options.ignore)) {
		if (options.verbose) {
	...
	function countLine() {
		...
		if (this[0].start && analyzing.indexOf(this) < 0) {
			...
			var lineId = this[0].name + this[0].start.line + "_" + this[0].start.pos;
			...
			if (options["function"]) {
				body.splice(0, 0, [ "stat",
					[ "call",
						...
						[
							["string", file],
							["string", fnName + "_" + this[0].start.line + "_" + this[0].start.pos]
						]
					]
				]);
				...
				rememberFunction(fnName + "_" + this[0].start.line + "_" + this[0].start.pos);
			}
	...
	return clientCode.generate(file, lines, allConditions, allFunctions, code, options);
};
