...
exports.createApp = function (options) {
	...
	function defaultReadReport (report, callback, req) {
	...
	function defaultReportsList (callback, req) {
	...
	var canMerge = (options.canMerge !== false);
	...
	app.get("/", function (req, res) {
		reportsList(function (err, reports) {
			if (err) {
				res.send("Error while reading reports list", 404);
			} else {
	...
	app.get("/r/:report", function (req, res) {
		readReport(req.params.report, sendReport.bind(this, req, res), req);
	});
	...
	if (canMerge) {
		app.get("/merge", function (req, res) {
			...
			readMultipleReports(toBeMerged, req, function (err, reports) {
				if (err) {
					res.send(404);
				} else {
	...
	function readMultipleReports (reports, req, callback) {
